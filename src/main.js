...
window.onload = function() {
    ...
    function init() {
        // Load images
        images = loadImages(["/sprites" /*"bubble-sprites.png"*/]);
    ...
    function render() {
        ...
        context.fillRect(level.x - 4, level.y - 4, canvas.width, level.height + 4 - yoffset);
        ...
        context.fillRect(level.x - 4, level.y - 4 + level.height + 4 - yoffset, canvas.width, 2*level.tileheight + 3);
    ...
    function drawFrame() {
        ...
        context.fillStyle = "#ffffff";
        context.font = "24px Verdana";
        context.fillText("Bubble Popper Abid & Mike", 10, 37);
